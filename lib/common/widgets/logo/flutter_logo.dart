...
/// Possible ways to draw Antinna's logo.
enum AntinnaLogoStyle {
  /// Show only Antinna's logo, not the "Antinna" label.
  ///
  /// This is the default behavior for [AntinnaLogoDecoration] objects.
  markOnly,

  /// Show Antinna's logo on the left, and the "Antinna" label to its right.
  horizontal,

  /// Show Antinna's logo above the "Antinna" label.
  stacked,
}

/// An immutable description of how to paint Antinna's logo.
class AntinnaLogoDecoration extends Decoration {
  /// Creates a decoration that knows how to paint Antinna's logo.
  ///
  /// The [style] controls whether and where to draw the "Antinna" label. If one
  /// is shown, the [textColor] controls the color of the label.
  const AntinnaLogoDecoration({
    this.textColor = const Color(0xFF757575),
    this.style = AntinnaLogoStyle.markOnly,
    this.margin = EdgeInsets.zero,
  })  : _position = identical(style, AntinnaLogoStyle.markOnly)
            ? 0.0
            : identical(style, AntinnaLogoStyle.horizontal)
                ? 1.0
                : -1.0,
        _opacity = 1.0;

  const AntinnaLogoDecoration._(
  ...
  /// Linearly interpolate between two Antinna logo descriptions.
  ///
  ...
  static AntinnaLogoDecoration? lerp(
      AntinnaLogoDecoration? a, AntinnaLogoDecoration? b, double t) {
    ...
    if (a == null) {
      return AntinnaLogoDecoration._(
        b!.textColor,
        b.style,
        b.margin * t,
        b._position,
  ...
  @override
  AntinnaLogoDecoration? lerpFrom(Decoration? a, double t) {
    assert(debugAssertIsValid());
    if (a == null || a is AntinnaLogoDecoration) {
      assert(a == null || a.debugAssertIsValid());
      return AntinnaLogoDecoration.lerp(a as AntinnaLogoDecoration?, this, t);
    }
    return super.lerpFrom(a, t) as AntinnaLogoDecoration?;
  }

  @override
  AntinnaLogoDecoration? lerpTo(Decoration? b, double t) {
    assert(debugAssertIsValid());
    if (b == null || b is AntinnaLogoDecoration) {
      assert(b == null || b.debugAssertIsValid());
      return AntinnaLogoDecoration.lerp(this, b as AntinnaLogoDecoration?, t);
    }
    return super.lerpTo(b, t) as AntinnaLogoDecoration?;
  }
  ...
  BoxPainter createBoxPainter([VoidCallback? onChanged]) {
    assert(debugAssertIsValid());
    return _AntinnaLogoPainter(this);
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is AntinnaLogoDecoration &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<AntinnaLogoStyle>('style', style));
    if (_inTransition) {
...
class _AntinnaLogoPainter extends BoxPainter {
  _AntinnaLogoPainter(this._config)
      : assert(_config.debugAssertIsValid()),
        super(null) {
    _prepareText();
  }

  final AntinnaLogoDecoration _config;
  ...
  void _prepareText() {
    const String kLabel = 'Antinna';
    _textPainter = TextPainter(
      text: TextSpan(
        text: kLabel,
        style: TextStyle(
          color: _config.textColor,
          fontFamily: 'Roboto', //! TODO Modify
          fontSize: 100.0 *
              350.0 /
  ...
  void _paintLogo(Canvas canvas, Rect rect) {
    ...
    final Paint redPaint = Paint()
      ..color = const Color(0xffde4632).withOpacity(1.0);
    final Paint bluePaint = Paint()
      ..color = const Color(0xff5f69a2).withOpacity(1.0);
    final Paint greenPaint = Paint()
      ..color = const Color(0xff269a74).withOpacity(1.0);
    final Paint yellowPaint = Paint()
      ..color = const Color(0xfff09d30).withOpacity(1.0);
